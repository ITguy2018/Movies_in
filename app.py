...
df = pd.read_csv('/Users/TEST/Desktop/Maps/maps/VTmoviesCoords.csv')
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col(html.Div([html.Iframe(id='map', srcDoc=open(
            '/Users/TEST/Desktop/Maps/maps/Movies_In_Vermont.html', 'r').read(), width='99%', height='620')], style={'width': '95%', 'display': 'inline-block'
